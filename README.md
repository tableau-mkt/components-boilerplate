...
A component library and automated style guide. This README focuses on
development within the component library to create new and modify existing
components. See the overview page of the generated style guide (demo below) for
...
## Legacy brower support
We use a mix of IE conditional statements, polyfills, and [modernizr](http://modernizr.com)
detection classes to account for legacy browsers. We recommend a [modernizr build that includes these detections](http://modernizr.com/download/?-backgroundsize-cssgradients-cssreflections-csstransforms-csstransforms3d-flexbox-fontface-geolocation-input-inputtypes-opacity-postmessage-svg-textshadow-video-addtest-domprefixes-mq-prefixes-setclasses-testallprops-testprop-teststyles).

### IE conditional classes
We recommend a set of IE condition classes based on your needs. Here is
a very granular example, choose a set based on your needs. We recommending having
at least `.lt-ie11` and `.lt-ie9` as these versions represent major feature gaps
in IE version history.

``` html
  <!--[if IEMobile 7]><html class="no-js ie iem7"><![endif]-->
  <!--[if lte IE 6]><html class="no-js ie lt-ie9 lt-ie8 lt-ie7"><![endif]-->
  <!--[if (IE 7)&(!IEMobile)]><html class="no-js ie lt-ie9 lt-ie8"><![endif]-->
  <!--[if IE 8]><html class="no-js ie ie8 lt-ie9 lt-ie11"><![endif]-->
  <!--[if IE 9]><html class="no-js ie ie9 lt-ie11"><![endif]-->
  <!--[if IE 10]><html class="no-js ie ie10 lt-ie11"><![endif]-->
  <!--[if (gt IE 10)|(gt IEMobile 7)]><html class="no-js ie lt-ie11"><![endif]-->
  <!--[if !IE]><!--><html class="no-js" lang=""><!--<![endif]-->
```
